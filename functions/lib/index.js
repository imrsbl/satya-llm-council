...
function setCorsHeaders(request, response) {
    ...
    response.set("Access-Control-Allow-Headers", "Content-Type, Authorization, Notion-Version");
 ...
 */
exports.notionProxy = functions.https.onRequest(async (request, response) => {
    var _a, _b;
    // Handle CORS
    ...
    try {
        ...
        const notionApiKey = process.env.NOTION_API_KEY ||
            ((_a = functions.config().notion) === null || _a === void 0 ? void 0 : _a.api_key);
        if (!notionApiKey) {
        ...
        if ((_b = request.body) === null || _b === void 0 ? void 0 : _b.url) {
        ...
        const notionResponse = await (0, node_fetch_1.default)(notionUrl, {
